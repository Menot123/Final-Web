                        ...
                        <div class="container">
                            ...
                            <div class="collapse navbar-collapse w-100" id="navbarSupportedContent">
                                <ul class="navbar-nav mb-2 mt-lg-0 mb-lg-0 d-flex justify-content-around w-100">
                                    ...
                                    <li class="nav-item">
                                        <a style="font-size: 150%; width: 100%; color:aliceblue" class="nav-link active text-primary" href="#">Xem phản hồi</a>
                                    </li>
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                while ($row = $stmt->fetch(PDO::FETCH_ASSOC))
                                                {
                                                    ...
                                                    echo '<td><a href="detail-contact.php?id='.$row["id"].'">Xem chi tiết</a> &nbsp; <a href="api/delete-contact.php?id='.$row["id"].'">Xóa</a></td>';
                                                    echo '</tr>';
                                                    $i++;
                                                }
