                        ...
                        <div class="container">
                            ...
                            <div class="collapse navbar-collapse w-100" id="navbarSupportedContent">
                                <ul class="navbar-nav mb-2 mt-lg-0 mb-lg-0 d-flex justify-content-around w-100">
                                    <li class="nav-item">
                                        <a style="font-size: 150%; width: 100%; color:aliceblue" class="nav-link active text-primary" aria-current="page" href="#">Quản lý tài khoản</a>
                                    </li>
                                    <li class="nav-item">
                                        <a style="font-size: 150%; width: 100%; color:aliceblue" class="nav-link " href="admin-watch-rooms.php">Quản lý phòng</a>
                                    </li>
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                while ($row = $stmt->fetch(PDO::FETCH_ASSOC))
                                                {
                                                    ...
                                                    echo '<td><a href="edit-user-form.php?id='.$row["id"].'">Sửa</a> &nbsp; <a href="api/delete-user.php?id='.$row["id"].'">Xóa</a></td>';
                                                    echo '</tr>';
                                                    $i++;
                                                }
